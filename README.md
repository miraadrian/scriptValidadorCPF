...
E se ele é realmente é um CPF válido ou não utilizando a mesma lógica utilizado pelo governo federal: o cálculo dos dígitos verificadores (baseado em mod-11).
